...
class IrrigationEntry{
	...
	equals(other){
		if( !other || !(other instanceof IrrigationEntry) ){
			return false;
		}
		return this.begin    === other.begin 
	...
	getArduinoValidObjectRepresentation(){
		return this;
	}
}
...
class RecurringIE extends IrrigationEntry{
	...
	equals(other){
		...
		return arraysEqual(this.daysOfWeek, other.daysOfWeek);
	}
	...
	getArduinoValidObjectRepresentation(){
		let validRepr = super.getArduinoValidObjectRepresentation();
		validRepr['weekdays'] = this.daysOfWeekToInt();
		return validRepr;
	}
